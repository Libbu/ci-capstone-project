...
urlpatterns = [
    ...
    path('<int:event_id>/delete_comment/<int:comment_id>/', views.delete_comment, name='delete_comment'),
    path('<int:event_id>/edit_comment/<int:comment_id>',views.edit_comment, name='edit_comment'),
