...
class Event(models.Model):
    ...
    organiser = models.ForeignKey(User, on_delete=models.CASCADE, related_name="event_organiser")  # noqa
    ...
    attendees = models.ManyToManyField(User, related_name='attendees', blank=True)  # noqa
